...
const initialWindows: WindowState[] = [
  ...
  },
  {
    ...
    icon: '/icons xp/Windows XP Icons/Task Manager.png',
    isOpen: false,
    isMinimized: false,
    zIndex: 1,
    position: { x: 220, y: 60 },
    size: { width: 460, height: 490 },
  },
  {
    id: 'msnmsgr',
    title: 'MSN Messenger',
    icon: '/icons xp/Windows XP Icons/MSN Messenger.png',
    isOpen: false,
    isMinimized: false,
    zIndex: 1,
    position: { x: 180, y: 40 },
  ...
  },
  {
    ...
    icon: '/icons xp/Windows XP Icons/Windows Picture and Fax Viewer.png',
    isOpen: false,
    isMinimized: false,
    zIndex: 1,
    position: { x: 140, y: 50 },
...
const desktopIcons = [
  ...
  { id: 'msnmsgr', icon: '/icons xp/Windows XP Icons/MSN Messenger.png', label: 'MSN Messenger' },
  { id: 'pictureviewer', icon: '/icons xp/Windows XP Icons/Windows Picture and Fax Viewer.png', label: 'Picture Viewer' },
...
const menuItems = [
  ...
  { id: 'pictureviewer', title: 'Windows Picture Viewer', icon: '/icons xp/Windows XP Icons/Windows Picture and Fax Viewer.png' },
...
export default function Desktop({ onLogOff, onShutdown }: DesktopProps) {
  ...
  // Global keyboard shortcuts (Ctrl+Shift+Esc for Task Manager)
  useEffect(() => {
  ...
  const getDesktopContextMenuItems = (): MenuItem[] => [
    ...
    { divider: true },
    { label: 'Task Manager', icon: '/icons xp/Windows XP Icons/Task Manager.png', onClick: () => openWindow('taskmgr') },
    ...
    switch (id) {
      ...
      case 'taskmgr':
        return (
          <TaskManagerContent
            openWindows={windows
              .filter(w => w.isOpen && w.id !== 'taskmgr')
              .map(w => ({ id: w.id, title: w.title, icon: w.icon, isMinimized: w.isMinimized }))}
      ...
      case 'msnmsgr':
        return <MsnMessengerContent />;
      case 'pictureviewer':
        return <PictureViewerContent />;
