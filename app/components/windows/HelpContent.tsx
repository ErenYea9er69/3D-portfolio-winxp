...
export default function HelpContent() {
  const apps = [
    ...
    { icon: '/icons xp/Windows XP Icons/Control Panel.png', name: 'Control Panel - Settings hub' },
    { icon: '/icons xp/Windows XP Icons/Windows Media Player 10.png', name: 'Media Player - Audio player' },
    { icon: '/icons xp/Windows XP Icons/Command Prompt.png', name: 'Command Prompt - Terminal' },
