  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column', margin: '-8px', background: '#fff' }}>
      ...
      <div style={{
        ...
        <span>Address</span>
        <div style={{ flex: 1, background: '#fff', border: '1px inset #808080', padding: '2px 6px', color: '#333' }}>
          📁 {name}
        </div>
      </div>
      <div style={{
        flex: 1, display: 'flex', flexDirection: 'column',
        alignItems: 'center', justifyContent: 'center', color: '#888', fontSize: '11px', gap: '6px',
      }}>
